...
public class BlueScoreWorlds extends LinearOpMode {
    ...
    public void red(int turn)
    {
        ...
        robot.DriveMotorUsingEncoder(0.25, 13, 10, 1);
        sleep(200);

        robot.DriveMotorUsingEncoder(0.25, 32, 10, 3);
        sleep(200);

        robot.DriveMotorUsingEncoder(0.5, turn,10,4);
        sleep(200);
        ...
        sleep(200);
        robot.DriveMotorUsingEncoder(0.25,forward,2,0);
        sleep(200);
