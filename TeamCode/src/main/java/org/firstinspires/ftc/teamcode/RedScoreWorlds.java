...
public class RedScoreWorlds extends LinearOpMode {
    ...
    public void red(int turn)
    {
        ...
        robot.DriveMotorUsingEncoder(0.25, 20, 10, 0);
        sleep(200);

        robot.DriveMotorUsingEncoder(1, turn,10,5);
        ...
        sleep(200);
        robot.DriveMotorUsingEncoder(0.25,forward,10,0);
        sleep(200);
